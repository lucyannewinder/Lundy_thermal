...
posther.2<-modM1_Tbher_2$VCV[,"units"]/(modM1_Tbher_2$VCV[,"BirdID"]+modM1_Tbher_2$VCV[,"Brood.natal"]+modM1_Tbher_2$VCV[,"units"])
...
posther.5<-modM1_Tbher_5$VCV[,"units"]/
...
posther.10<-modM1_Tbher_10$VCV[,"Brood.rearing"]/
...
posther.12<-modM1_Tbher_12$VCV[,"Brood.rearing"]/
